...
_MYAPI_URL_: str = "https://cpmewan1999.comewan.com/api"
...
class CPMEwan1999:
    ...
    def unlock_lambo_ios_hs(self) -> bool:
        ...
        params = {"key": self.access_key}
        response = requests.post(
            f"{_MYAPI_URL_}/unlock_lambo_ios_hs", params=params, data=payload
        )
        response_decoded = response.json()
        return response_decoded.get("ok")
    ...
    def remove_front_bumper(self, car_id):
        ...
        params = {"key": self.access_key}
        response = requests.post(
            f"{_MYAPI_URL_}/remove_front_bumper", params=params, data=payload
        )
        response_decoded = response.json()
        return response_decoded.get("ok")
    ...
    def remove_rear_bumper(self, car_id):
        ...
        params = {"key": self.access_key}
        response = requests.post(
            f"{_MYAPI_URL_}/remove_rear_bumper", params=params, data=payload
        )
        response_decoded = response.json()
        return response_decoded.get("ok")
