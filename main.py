...
if __name__ == "__main__":
    ...
    while True:
        ...
        while True:
            ...
            print(Colorate.Horizontal(Colors.rainbow, '➩{18}: Unlock All Wheels        4.000K'))                                    
            ...
            print(Colorate.Horizontal(Colors.rainbow, '➩{23}: Speed Car Hack (Car_ID)  2.500K'))
            print(Colorate.Horizontal(Colors.rainbow, '➩{24}: Speed All Cars Hack      3.000K'))
            print(Colorate.Horizontal(Colors.rainbow, '➩{25}: Chrome All Cars          3.500K'))            
            print(Colorate.Horizontal(Colors.rainbow, '➩{26}: All Cars Max Milage      3.000K'))                        
