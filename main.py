...
def load_player_data(cpm):
    ...
    if response.get('ok'):
        ...
        if 'floats' in data and 'localID' in data and 'money' in data and 'coin' in data:
            ...
            print(Colorate.Horizontal(Colors.rainbow, f'📍[Name ➦ {(data.get("Name") if "Name" in data else "UNDEFINED")}] [📍LocalID ➦ {data.get("localID")}] [📍Money  : {data.get("money")}] [📍Coins  : {data.get("coin")}]'))
