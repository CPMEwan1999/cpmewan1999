...
if __name__ == "__main__":
    ...
    while True:
        ...
        while True:
            ...
            print(Colorate.Horizontal(Colors.rainbow, Box.DoubleCube( '➩{01}: Increase Money            1.000K')))
            print(Colorate.Horizontal(Colors.rainbow, Box.DoubleCube( '➩{02}: Increase Coins            3.000K')))
            print(Colorate.Horizontal(Colors.rainbow, Box.DoubleCube( '➩{03}: King Rank                 3.500K')))
            print(Colorate.Horizontal(Colors.rainbow, Box.DoubleCube( '➩{04}: Change ID                 2.500K')))
            print(Colorate.Horizontal(Colors.rainbow, Box.DoubleCube( '➩{05}: Change Name               1.00K')))
            print(Colorate.Horizontal(Colors.rainbow, Box.DoubleCube( '➩{06}: Change Name (Rainbow)     1.00K')))
            print(Colorate.Horizontal(Colors.rainbow, Box.DoubleCube( '➩{07}: Number Plates             2.000K')))
            print(Colorate.Horizontal(Colors.rainbow, Box.DoubleCube( '➩{08}: Account Delete            FREE')))
            print(Colorate.Horizontal(Colors.rainbow, Box.DoubleCube( '➩{09}: Account Register          FREE')))
            print(Colorate.Horizontal(Colors.rainbow, Box.DoubleCube( '➩{10}: Delete Friends            5.00K')))
            print(Colorate.Horizontal(Colors.rainbow, Box.DoubleCube( '➩{11}: Unlock Paid Cars          3.500K')))
            print(Colorate.Horizontal(Colors.rainbow, Box.DoubleCube( '➩{12}: Unlock all Cars           4.000K')))
            print(Colorate.Horizontal(Colors.rainbow, Box.DoubleCube( '➩{13}: Unlock all Cars Siren     3.500K')))
            print(Colorate.Horizontal(Colors.rainbow, Box.DoubleCube( '➩{14}: Unlock w16 Engine         3.000K')))
            print(Colorate.Horizontal(Colors.rainbow, Box.DoubleCube( '➩{15}: Unlock All Horns          3.000K')))
            print(Colorate.Horizontal(Colors.rainbow, Box.DoubleCube( '➩{16}: Unlock Disable Damage     2.000K')))
            print(Colorate.Horizontal(Colors.rainbow, Box.DoubleCube( '➩{17}: Unlock Unlimited Fuel     2.000K')))
            print(Colorate.Horizontal(Colors.rainbow, Box.DoubleCube( '➩{18}: Unlock All Wheels         2.500K')))
            print(Colorate.Horizontal(Colors.rainbow, Box.DoubleCube( '➩{19}: Unlock House 3            2.500K')))
            print(Colorate.Horizontal(Colors.rainbow, Box.DoubleCube( '➩{20}: Unlock Smoke              2.000K')))
            print(Colorate.Horizontal(Colors.rainbow, Box.DoubleCube( '➩{21}: Change Race Wins          7.00K')))
            print(Colorate.Horizontal(Colors.rainbow, Box.DoubleCube( '➩{22}: Change Race Loses         7.00K')))
            print(Colorate.Horizontal(Colors.rainbow, Box.DoubleCube( '➩{23}: Speed Car Hack (Car_ID)   1.500K')))
            print(Colorate.Horizontal(Colors.rainbow, Box.DoubleCube( '➩{24}: Speed All Cars Hack       2.500K')))
